...
unrealRootPath=/usr/local/src/UnrealEngine
sc2RootPath=/home/bp1/Documents/Unreal Projects/sc2

gameProjectFile=/home/bp1/Documents/Unreal Projects/sc2/sc2.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(sc2Source.pri)
include(sc2Header.pri)
include(sc2Config.pri)
include(sc2Includes.pri)
include(sc2Defines.pri)
...
sc2-Linux-Debug.commands = $$build sc2 Linux Debug  -project="\"$$gameProjectFile\"" $$args
sc2-Linux-DebugGame.commands = $$build sc2 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
sc2-Linux-Shipping.commands = $$build sc2 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
sc2-Linux-Test.commands = $$build sc2 Linux Test  -project="\"$$gameProjectFile\"" $$args
sc2.commands = $$build sc2 Linux Development  -project="\"$$gameProjectFile\"" $$args

sc2Editor-Linux-Debug.commands = $$build sc2Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
sc2Editor-Linux-DebugGame.commands = $$build sc2Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
sc2Editor-Linux-Shipping.commands = $$build sc2Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
sc2Editor-Linux-Test.commands = $$build sc2Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
sc2Editor.commands = $$build sc2Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	sc2-Linux-Test \
	sc2 \
	sc2Editor-Linux-Debug \
	sc2Editor-Linux-DebugGame \
	sc2Editor-Linux-Shipping \
	sc2Editor-Linux-Test \
	sc2Editor \
